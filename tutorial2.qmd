...
2.  Show that marginal productivity is positive for capital and labour
3.  Show that marginal productivity is decreasing for capital and labour
...
4.  What happen if $sAk^\alpha > (\delta - n)k$? Interpret
...
2.  How does change the steady-state level of capital per capita?
3.  How does change the steady-state level of output per capita?
...
1.  Show that $g_y \propto g_k$

### 8. Introducing technological progress \[Bonus\]

Let assume now that $A$ grows at rate $\dot A / A = g > 0$.

1.  What is the new law of capital accumulation?
2.  What is the steady-state level of output per capita $\tilde{y}^\star$?