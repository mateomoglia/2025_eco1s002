...
-   Using Harrod-neutral technological progress, the GDP per capita equation is:
$$
...
-   Super convenient: we can measure everything
    ...
    -   $\delta$, capital depreciation (assumed constant)
    -   $g$, growth rate of technology (assumed constant)
